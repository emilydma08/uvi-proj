...
EXISTING_CSV = "gsv_abuja_extended.csv"
OUTPUT_CSV = "gsv_abuja_extended2.csv"

NEW_TILES = [
    # ── Clusters 39–40 (Karshi / northern fringe) ────────────
    (7.35, 9.26, 7.40, 9.30),
    (7.40, 9.26, 7.45, 9.30),

    # ── Clusters 52–56 (southwestern, ~Gwagwalada outer) ─────
    (7.06, 8.92, 7.11, 8.97),
    (7.11, 8.92, 7.16, 8.97),
    (7.06, 8.96, 7.11, 9.00),
    (7.11, 8.96, 7.16, 9.00),

    # ── Cluster 60 (Abaji fringe) ─────────────────────────────
    (7.02, 8.79, 7.07, 8.83),
    (7.07, 8.79, 7.12, 8.83),
]
