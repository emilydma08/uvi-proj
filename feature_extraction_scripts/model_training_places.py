...
# ── Load ──────────────────────────────────────────────────────────────────────
X = np.load("resnet_places_features/X_clusters.npy")  # (44, 2048)
y = np.load("resnet_places_features/y_labels.npy")    # (44,)
cluster_ids = pd.read_csv("resnet_places_features/cluster_ids.csv")
